(function () {
  ...
  function showFatal(err) {
    try {
      ...
      tip.textContent = "If you can, also open DevTools Console and copy the first red error line.";
  ...
  function boot() {
    try {
      // ==========================================================
      // YOUR ORIGINAL CODE STARTS HERE (only wrapped safely)
      // ==========================================================
      ...
      // ✅ ensure #app exists (prevents null crash)
